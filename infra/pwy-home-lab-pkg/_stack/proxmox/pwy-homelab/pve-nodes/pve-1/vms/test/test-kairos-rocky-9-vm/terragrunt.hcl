...
# ---------------------------------------------------------------------------
# VM booted from the Kairos Rocky Linux 9 ISO built by infra/image-maker-pkg/_tg_scripts/image-maker/build-images.
...
#   iso_file_id:    "local:iso/kairos-rocky-9.iso"  # required
#   vm_name:        test-kairos-rocky-9-vm
