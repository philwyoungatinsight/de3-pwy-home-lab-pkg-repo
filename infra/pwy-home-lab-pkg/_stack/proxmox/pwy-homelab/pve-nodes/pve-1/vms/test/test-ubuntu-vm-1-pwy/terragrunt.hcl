...
# Add entries under "pwy-home-lab-pkg/_stack/proxmox/pwy-homelab/pve-nodes/pve-1/vms/test/test-ubuntu-vm-1-pwy"
# (or the pve-1 level) to override any of the following:
#
#   vm_name:              test-ubuntu-vm-1   # defaults to the unit directory name
