...
# Commission ms01-02 in MaaS and deploy Ubuntu noble to it.
#
...
#      providers.maas.config_params["pwy-home-lab-pkg/_stack/maas/pwy-homelab/machines/ms01-02"]
...
locals {
  ...
  # Supported: smart_plug (→ MaaS webhook), ipmi (iDRAC/iLO/CIMC), redfish (iDRAC 9+/iLO 5+), amt (default).
